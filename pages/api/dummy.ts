...
const AUTH0_DOMAIN = ''; // your domain e.g dev-dsdrfu543y459f
...
export default async function handler(req: Request, res: Response) {
  if (req.method === 'POST') {
    ...
    errorLogs.map((message: Auth0LogPayload) => {
      ...
      // example link: https://manage.auth0.com/dashboard/us/dev-jfgkdjg9879345/logs/90020230902134725725131000000000000001223372039797809571
